...
DROP PROCEDURE up_12L_slip_gen_en
GO
create procedure up_12L_slip_gen_en (
@num bigint ,
@userid varchar(20)
)
as
begin
--01.宣告變數
declare @swt       char(10)		declare @slipno2e  varchar(20)	  declare @ustono   char(20)
...
select @num_25a=num from slip where slipno2 =@slipno2e 
--05.防呆機制之二
if chjer.dbo.uf_empty(@slipno2e)='N' 
begin
...
--08回寫單據之傳票序號
update deplh set slipno2e = '' , slipnoe = '' where num = @num 
end 
